...
@task
def load_images(train_dir, test_dir, train_datagen, test_datagen, target_size=(64, 64), batch_size=32, class_mode='binary'):
...
@flow
def main_load_flow(train_dir:str='data/train', test_dir:str='data/test', rescale:float=1./255, shear_range:float=0.2, zoom_range:float=0.2, horizontal_flip:bool=True, target_size:tuple=(64, 64), batch_size:int=32, class_mode:str='binary'):
